 ...
 */
package tutorial.lorence.template.custom.pdfviewer;
...
import tutorial.lorence.template.custom.pdfviewer.source.AssetSource;
import tutorial.lorence.template.custom.pdfviewer.source.ByteArraySource;
import tutorial.lorence.template.custom.pdfviewer.source.FileSource;
import tutorial.lorence.template.custom.pdfviewer.source.InputStreamSource;
import tutorial.lorence.template.custom.pdfviewer.source.UriSource;
import tutorial.lorence.template.custom.pdfviewer.util.ArrayUtils;
import tutorial.lorence.template.custom.pdfviewer.util.Constants;
import tutorial.lorence.template.custom.pdfviewer.util.NumberUtils;
...
public class PDFView extends SurfaceView {
    ...
    /**
     * Assign onScroll and onFling to the PDF View
     * Assign onScale to the main container
     */
    public interface GestureEventInterface {
        ...
        void handleEndScroll(MotionEvent event);
    }

    public boolean onScroll(MotionEvent e1, MotionEvent e2, float distanceX, float distanceY) {
        return dragPinchManager.onScroll(e1, e2, distanceX, distanceY);
    }

    public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
        return dragPinchManager.onFling(e1, e2, velocityX, velocityY);
    }

    public boolean onDown(MotionEvent event) {
        return dragPinchManager.onDown(event);
    }

    public void handleEndScroll(MotionEvent event) {
        dragPinchManager.handleEndScroll(event);
    }
