...
class DragPinchManager implements GestureDetector.OnGestureListener, GestureDetector.OnDoubleTapListener, ScaleGestureDetector.OnScaleGestureListener, View.OnTouchListener {
    ...
    private tutorial.lorence.template.custom.pdfviewer.PDFView pdfView;
    private tutorial.lorence.template.custom.pdfviewer.AnimationManager animationManager;
...
//        pdfView.setOnTouchListener(this);
    ...
    /**
     * Never be triggered. Because the onTouch event has assigned by the main container
     * So that, only the onScroll, onFling events will be called by CustomZoomViewAdapter through interface
     */
    @Override
