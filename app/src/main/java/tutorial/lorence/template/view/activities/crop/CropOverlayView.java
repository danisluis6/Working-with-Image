...
public class CropOverlayView extends View {
    ...
    public CropOverlayView(Context context, AttributeSet attrs) {
        ...
        this.DEFAULT_CROPWIDTH = context.getResources().getDisplayMetrics().widthPixels;
        int DEFAULT_BOARDER_COLOR = 0xFFFFFFFF;
        int DEFAULT_BACKGROUND_COLOR = 0x60C9C3C3;
        float DEFAULT_CORNER_RADIUS = 6;
        try {
            mGuidelines = ta.getBoolean(R.styleable.CropOverlayView_guideLines, false);
            mDrawCircle = ta.getBoolean(R.styleable.CropOverlayView_drawCircle, false);
            mMarginTop = ta.getDimensionPixelSize(R.styleable.CropOverlayView_marginTop, (ImageViewUtil.getPosHeight((Activity) mContext) - DEFAULT_CROPWIDTH) / 2);
            mMarginSide = ta.getDimensionPixelSize(R.styleable.CropOverlayView_marginSide, (ImageViewUtil.getPosWidth((Activity) mContext) - DEFAULT_CROPWIDTH) / 2);
    ...
    private void init(Context context) {
        ...
        int edgeB = mMarginTop + DEFAULT_CROPWIDTH;
        int edgeL = mMarginSide;
        int edgeR = mMarginSide + DEFAULT_CROPWIDTH;
